...
{
    defineTypeNameAndDebug(driven3DofMotion, 0);
...
Foam::solidBodyMotionFunctions::driven3DofMotion::driven3DofMotion
(
...
Foam::septernion
Foam::solidBodyMotionFunctions::driven3DofMotion::transformation() const
{
   ...
   quaternion RR(axis, CofGro_.value()[2]);
...
bool Foam::solidBodyMotionFunctions::driven3DofMotion::read
(
    const dictionary& SBMFCoeffs
)
{
